    ...
    <div class="wrap">
        <div class="search">
            <form actiion='' method="post">
                <input type="text" name="search" id="skillsInput" oninput="showSuggestions()" class="searchTerm"
                    placeholder="Looking for a specific job? Search here.">
                            ...
                            <div class="p-info">
                                ...
                                <div style="display:flex;justify-content:space-between;width:100%;">
                                    <p><strong>Posted by:</strong>
                                        <?php echo htmlspecialchars($row['users_uname']); ?>
                                    </p>
                                    <p><strong>Company Name:</strong>
                                        <?php echo htmlspecialchars($row['job_compname']); ?>
                                    </p>
                                </div>
                                <p><strong>Description:</strong>
                                    <?php echo htmlspecialchars(mb_strimwidth($row['job_description'], 0, 80, "...")); ?>
                                </p>
                                <p><strong>Skills:</strong>
                                    <?php echo htmlspecialchars(mb_strimwidth($row['job_skills'], 0, 80, "...")); ?>
                                </p>
                                <p><strong>Pay/Income:</strong>
                                    <?php echo htmlspecialchars($row['job_income']); ?>
                                </p>
                            </div>
                            <div class="p-img">
                ...
                <?php foreach ($jobs as $job): ?>
                    <div class="job-card">
                        <div class="p-info">
                            ...
                            <div style="display:flex;justify-content:space-between;width:100%;">
                                <p><strong>Posted by:</strong>
                                    <?php echo htmlspecialchars($job['users_uname']); ?>
                                </p>
                                <p><strong>Company Name:</strong>
                                    <?php echo htmlspecialchars($job['job_compname']); ?>
                                </p>
                            </div>
                            <hr>
                            <p><strong>Description:</strong>
                                <?php echo htmlspecialchars(mb_strimwidth($job['job_description'], 0, 80, "...")); ?>
                            </p>
                            <p><strong>Skills:</strong>
                                <?php echo htmlspecialchars(mb_strimwidth($job['job_skills'], 0, 80, "...")); ?>
                            </p>
                            <p><strong>Pay/Income:</strong>
                                <?php echo htmlspecialchars($job['job_income']); ?>
                            </p>
                        </div>
                        <!-- <div class="p-img"> -->
                        <?php if (isset($_SESSION["isEmployer"]) && $_SESSION["isEmployer"] != 1): ?>
